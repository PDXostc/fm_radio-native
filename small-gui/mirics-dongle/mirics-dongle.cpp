...
#define	DEFAULT_GAIN	40
	...
	miricsDongle::miricsDongle (int32_t inputRate, bool *success) {
int	err;
float	ver;
...
int32_t	miricsDongle::setExternalGain	(int newGain) {
...
int32_t	miricsDongle::getSamples (DSPCOMPLEX *V, int32_t size, uint8_t M) {
	(void)M;
...
int32_t	miricsDongle::getBandwidth	(int32_t rate) {
